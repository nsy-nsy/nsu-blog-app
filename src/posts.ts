...
export const starterPosts: Post[] = [
  ...
  },
  {
    ...
    body:
      "리눅스를 처음 설치할 때 가장 헷갈리는 부분은 배포판 선택보다 설치 흐름입니다. 큰 흐름은 ISO 파일 다운로드, USB 제작, USB 부팅, 디스크 선택, 사용자 생성, 설치 후 업데이트입니다.\n\n먼저 설치할 배포판을 정합니다. 처음이라면 Ubuntu나 Linux Mint처럼 자료가 많은 배포판이 편합니다. 서버용이라면 AlmaLinux, Rocky Linux, Debian도 좋은 선택입니다. 배포판 공식 사이트에서 ISO 파일을 받고, 가능하면 체크섬을 확인해 파일이 정상인지 보는 것이 좋습니다.\n\nWindows에서는 Rufus나 balenaEtcher로 부팅 USB를 많이 만듭니다. USB를 선택하고 ISO 파일을 지정한 뒤 시작하면 됩니다. USB 안의 기존 자료는 지워질 수 있으니 꼭 백업해야 합니다.\n\n설치할 컴퓨터를 재부팅하고 F2, F12, Del 같은 키로 부팅 메뉴에 들어갑니다. 부팅 목록에서 USB를 선택하면 리눅스 설치 화면이 나옵니다. 디스크 선택 단계에서는 Windows를 지우고 리눅스만 쓸 것인지, 듀얼부팅을 할 것인지 먼저 정해야 합니다.\n\n설치가 끝나면 Ubuntu 계열은 sudo apt update && sudo apt upgrade, Fedora 계열은 sudo dnf update로 업데이트합니다. 그래픽 드라이버, 와이파이, 블루투스, 한글 입력이 정상인지도 확인합니다.",
  ...
  },
  {
    ...
    body:
      "안녕하세요 루이입니다\n\n이번에 포스팅 할 제품은 로아 하이킹 브랜드의 제품 \"Sella\" 스니커즈 입니다.\n이탈리아의 기반으로 둔 브랜드이며 산악용 제품을 일상생활에서도 편하게 입을수 있게끔 만든 브랜드입니다.\n\n요즘 유행하는 고프코어에 딱 어울리는 브랜드라고 생각이 드네요.\n\n셀라라는 라인이 이번에 로아에서 새로 나온 신발인데 발매때 올리브 색상은 여성사이즈 제일 작은거말곤 다 품절이 된걸보면 인기가 생각보다 있는거 같습니다.\n\n상자는 이전 카타리나와 같은 박스이지만 크기는 살짝 작아졌습니다. 이전과 다르게 비브람솔 종이가 한개가 아닌 3개로 늘어났고 이 종이들을 묶어서 주는군요.\n\n셀라 스니커즈의 옆면 모습입니다. 쉐잎의 느낌이 호카가 생각나는 하이킹화네요. 카타리나는 내피들이 빵빵하게 되어있다면 이 제품은 러닝화느낌마냥 얇게 되어있습니다.\n\n미드솔 부분, 밑창을 눌러보면 러닝화처럼 정말 쫀득하게 들어가고 착화감도 러닝화처럼 통통 튀는 느낌도 나면서 카타리나보다 훨씬 편하더군요.\n\n셀라같은 경우 종이 슈트리가 이렇게 들어가 있습니다. 제품이 얇아서 쉐잎을 잡아주려고 이렇게 넣은것 같네요.\n\n신발끈은 하이킹화 스럽게 스카치 포인트가 들어가 있으며 끝쪽 팁에는 ROA라고 적혀있네요. 밑창은 이렇게 되어있으며 이전 등산용 신발들보다 접지력이 높게 제작되었네요.\n\n올리브 색상과 블랙 색상 비교샷 입니다. 카타리나와 비교샷 입니다.\n\n이상 로아의 신제품 셀라 리뷰였습니다.",
